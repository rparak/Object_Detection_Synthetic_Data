...
def main():
    ...
    file_path_old = f'{project_folder}/YOLO/Results/Type_{CONST_DATASET_TYPE}/train_fb_{CONST_FREEZE_BACKBONE}/weights/'
    file_path_new = f'{project_folder}/YOLO/Model/Type_{CONST_DATASET_TYPE}/'
