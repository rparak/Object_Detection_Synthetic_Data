...
def main():
    ...
    file_path_old = f'{project_folder}/YOLO/Results/Type_{CONST_DATASET_TYPE}/train_fb_{CONST_FREEZE_BACKBONE}/'
    file_path_new = f'{project_folder}/YOLO/Results/Type_{CONST_DATASET_TYPE}/'
