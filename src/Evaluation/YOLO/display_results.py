...
def main():
    ...
    file_path = f'{project_folder}/YOLO/Result/Type_{CONST_DATASET_TYPE}_Obj_ID_{CONST_OBJECT_ID}_v1'  
    ...
    # GloU.
    ax[0].plot(epoch, data[data.columns[1]], 'o-', color=[0.2,0.4,0.6,1.0], linewidth=2.0, label='train')
    ax[0].plot(epoch, data[data.columns[8]], 'o-', color=[1.0,0.85,0.75,1.0], linewidth=2.0, label='valid')
    ...
    # Objectness.
    ax[1].plot(epoch, data[data.columns[2]], 'o-', color=[0.2,0.4,0.6,1.0], linewidth=2.0, label='train')
    ax[1].plot(epoch, data[data.columns[9]], 'o-', color=[1.0,0.85,0.75,1.0], linewidth=2.0, label='valid')
    #   Set parameters of the visualization.
    ...
    # Classification.
    ax[2].plot(epoch, data[data.columns[3]], 'o-', color=[0.2,0.4,0.6,1.0], linewidth=2.0, label='train')
    ax[2].plot(epoch, data[data.columns[10]], 'o-', color=[1.0,0.85,0.75,1.0], linewidth=2.0, label='valid')
    #   Set parameters of the visualization.
    ...
    ax[3].plot(epoch, data[data.columns[4]], 'o-', color=[0.2,0.4,0.6,1.0], linewidth=2.0, label='precision')
    ax[3].plot(epoch, data[data.columns[5]], 'o-', color=[1.0,0.85,0.75,1.0], linewidth=2.0, label='recall')
    #   Set parameters of the visualization.
    ...
    ax[4].plot(epoch, data[data.columns[6]], 'o-', color=[0.2,0.4,0.6,1.0], linewidth=2.0, label='mAP@0.5')
    ax[4].plot(epoch, data[data.columns[7]], 'o-', color=[1.0,0.85,0.75,1.0], linewidth=2.0, label='mAP@0.5:0.95')
    #   Set parameters of the visualization.
    ax[4].set_title('mAP')
