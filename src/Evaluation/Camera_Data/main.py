...
def main():
    """
    Description:
        A simple script to display data from a real camera (raw, processed). In our case it is the camera 
        from the PhoXi 3D Scanner M.
    ...
    if CONST_SHOW_IMG_MATPLOTLIB == True:
        ...
        ax[1, 1].plot(processed_image_hist, '-', linewidth=1.0, color=[0.2,0.4,0.6,0.75], label='Processed Imaage')
